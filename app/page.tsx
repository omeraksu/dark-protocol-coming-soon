    ...
    <div className="min-h-screen flex flex-col">
      <header className="max-w-7xl mx-auto w-full px-6 py-6 flex items-center justify-between relative">
        <div className="flex items-center gap-2">
          <img src="/dark-logo.svg" alt="Dark" className="h-8" />
          <span className="text-xs text-white/50 px-2 py-0.5 bg-white/5 rounded border border-white/10">
            coming back
          </span>
        </div>

        <nav className="absolute left-1/2 -translate-x-1/2 flex items-center gap-8 text-sm">
      ...
      <footer className="max-w-7xl mx-auto w-full px-6 py-8">
        <div className="flex items-center justify-center gap-8 text-sm text-white/40">
          <img src="/dark-logo.svg" alt="Dark" className="h-5 opacity-60" />
